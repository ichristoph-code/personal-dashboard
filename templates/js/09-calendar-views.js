...
function renderWeekView() {
    ...
    for (var i = 0; i < 7; i++) {
        ...
        evts.forEach(function(evt) {
            ...
            var wkBgColor = hexToRgba(calColor, evt.all_day ? 0.45 : 0.35);
            var wkTextColor = darkenHex(calColor, 0.55);
        ...
        for (var d = 0; d < 7; d++) {
            ...
            if (evts.length > 0 && inMonth) {
                ...
                evts.forEach(function(evt, idx) {
                    ...
                    var bgAlpha = evt.all_day ? 0.45 : 0.35;
                    var bgColor = hexToRgba(color, bgAlpha);
                    var textColor = darkenHex(color, 0.55);
